...
<body data-gr-c-s-loaded="true">
					...
					function() {
						$.ajax({
							...
							success:function(data){  
			                    addresses=eval(data); 
			                    alert("zise"+addresses.length);
			                    addMarker(geocoder,map,addresses);
    ...
    function addMarker(geocoder,resultMap,addresses) {
		alert("eeeeeee");
		alert("addmarkerlength:"+addresses.length);
      for (var j = 0; j < addresses.length; ++j) {	
    	  
    	  alert("ttt"+addresses[j].zipcode);
			geocoder.geocode(
						{
